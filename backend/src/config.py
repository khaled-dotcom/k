...
MODEL_PATHS = [
    os.path.join(BASE_DIR, "server", "artifacts", 'hand_gesture_classifier.joblib'),  # Modal path
    os.path.join(BASE_DIR, "artifacts", 'hand_gesture_classifier.joblib'),  # Local path
    os.path.join(BASE_DIR, "backend", "server", "artifacts", 'hand_gesture_classifier.joblib'),  # Alternative
]
...
if model is None:
    print("Warning: Model file not found in any path")
